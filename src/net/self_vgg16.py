...
class self_vgg16(SubnetBase):
	...
	def Build(self):
		...
		net = ConvLayer('Conv_1_2', net, filterSize_=3, numberOfFilters_=64, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_1_2')
		net = MaxPoolLayer('Pool_1', net, kernelSize_=2, stride_=2, padding_='SAME')
			
		net = ConvLayer('Conv_2_1', net, filterSize_=3, numberOfFilters_=128, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_2_1')
		net = ConvLayer('Conv_2_2', net, filterSize_=3, numberOfFilters_=128, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_2_2')
		net = MaxPoolLayer('Pool_2', net, kernelSize_=2, stride_=2, padding_='SAME')

		net = ConvLayer('Conv_3_1', net, filterSize_=3, numberOfFilters_=256, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_3_1')
		net = ConvLayer('Conv_3_2', net, filterSize_=3, numberOfFilters_=256, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_3_2')
		net = ConvLayer('Conv_3_3', net, filterSize_=3, numberOfFilters_=256, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_3_3')
		net = MaxPoolLayer('Pool_3', net, kernelSize_=2, stride_=2, padding_='SAME')

		net = ConvLayer('Conv_4_1', net, filterSize_=3, numberOfFilters_=512, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_4_1')
		net = ConvLayer('Conv_4_2', net, filterSize_=3, numberOfFilters_=512, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_4_2')
		net = ConvLayer('Conv_4_3', net, filterSize_=3, numberOfFilters_=512, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_4_3')
		net = MaxPoolLayer('Pool_4', net, kernelSize_=2, stride_=2, padding_='SAME')

		net = ConvLayer('Conv_5_1', net, filterSize_=3, numberOfFilters_=512, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_5_1')
		net = ConvLayer('Conv_5_2', net, filterSize_=3, numberOfFilters_=512, stride_=1, padding_='SAME', isTrainable_=True)
		net = tf.nn.relu(net, 'RELU_5_2')
		net = ConvLayer('Conv_5_3', net, filterSize_=3, numberOfFilters_=512, stride_=1, padding_='SAME', isTrainable_=True)
